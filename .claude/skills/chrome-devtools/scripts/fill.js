...
/**
 * Fill form fields
 * Usage: bun fill.js --selector "#input" --value "text" [--url https://example.com]
 * Supports both CSS and XPath selectors:
 *   - CSS: bun fill.js --selector "#email" --value "user@example.com"
 *   - XPath: bun fill.js --selector "//input[@type='email']" --value "user@example.com"
 */
