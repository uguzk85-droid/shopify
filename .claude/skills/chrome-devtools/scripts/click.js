...
/**
 * Click an element
 * Usage: bun click.js --selector ".button" [--url https://example.com] [--wait-for ".result"]
 * Supports both CSS and XPath selectors:
 *   - CSS: bun click.js --selector "button.submit"
 *   - XPath: bun click.js --selector "//button[contains(text(),'Submit')]"
 */
